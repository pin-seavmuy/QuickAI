  ...
  const onSubmitHandler = async (e)=>{
      ...
      try {
        ...
        if(object.split(' ').length > 1){
          return toast.apply('Please enter only one object name')
        }
...

        {
          !content ? (
            <div className='flex-1 flex justify-center items-center'>
              <div className='text-sm flex flex-col items-center gag-5 text-gray-400'>
                <Scissors className='w-9 h-9'/>
                <p>Uupload an image and click "Remove Object" to get started</p>
            </div>
            </div>
          ) : (
