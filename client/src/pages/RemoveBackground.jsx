  ...
  return (
    <div className='h-full overflow-y-scroll flex p-6 items-start flex-wrap gap-4 text-slate-700'>
        ...
        <form onSubmit={onSubmitHandler} action="" className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
            ...
            <p className='text-xs text-gray-500 font-light mt-1'>Suuport JPG, PNG, and other image formats</p>
        ...
        <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
            ...
            {!content ? (
                ...
                <div className="flex-1 mt-3 flex items-center justify-center overflow-hidden rounded-md bg-gray-50">
                <img
                    src={content}
                    alt="Processed"
