...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <div className='w-full border-t border-gray-200 p-4 px-7 flex itetms-center justify-between'>
        <div onClick={openUserProfile} className='clex gap-2 items-center cursor-pointer'>
